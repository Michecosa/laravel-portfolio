            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="d-flex flex-column gap-4">
                        ...
                        <div class="about-feature-card soft-transition d-flex gap-4 p-4 rounded-4 shadow-sm-hover transition-all">
                            ...
                            <div>
                                <h3 class="h5 fw-bold text-slate-900 mb-2">Clean Code</h3>
                                <p class="text-slate-600 mb-0">Writing maintainable, scalable, and well-documented code that stands the test of time.</p>
                            </div>
                        </div>
                        ...
                        <div class="about-feature-card soft-transition d-flex gap-4 p-4 rounded-4 shadow-sm-hover transition-all">
                            ...
                            <div>
                                <h3 class="h5 fw-bold text-slate-900 mb-2">Fast Performance</h3>
                                <p class="text-slate-600 mb-0">Optimizing applications for speed and efficiency to deliver the best user experience.</p>
                            </div>
                        </div>
